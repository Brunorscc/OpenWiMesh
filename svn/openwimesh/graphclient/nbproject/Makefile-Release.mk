...
# C Compiler Flags
CFLAGS=-D__GIT_VERSION=\"$(GIT_VERSION)\" -rdynamic
...
${OBJECTDIR}/src/arpInfo.o: src/arpInfo.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags libnl-3.0 libnl-genl-3.0`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/arpInfo.o src/arpInfo.c

${OBJECTDIR}/src/associations.o: src/associations.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags libnl-3.0 libnl-genl-3.0`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/associations.o src/associations.c

${OBJECTDIR}/src/graphClient.o: src/graphClient.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags libnl-3.0 libnl-genl-3.0`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/graphClient.o src/graphClient.c
